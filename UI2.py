...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("src/ObshVid.PNG"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "x"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.test_list), _translate("MainWindow", "Решение тестовой задачи"))
...
"тестовую задачу"))
    ...
    def setTable(self):
        ...
        f_test_list = Zeydel_solve_test(int(self.n_line.text()), int(self.m_line.text()), int(self.N_max_line.text()),
                                   float(self.eps_line.text()), float(self.omega_line.text()))[5]
